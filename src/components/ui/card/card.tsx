...
export default function Card(
  ...
  return (
    ...
    draggable
    key={card.id}
    className={`animate-once animate-fade bg-[#2C2C2C] p-2 mb-2 flex flex-col rounded-md shadow-md ${isDraggingOverCard === card.id ? "border-2 border-blue-500" : ""} ${card.id == draggingCard?.id ? "opacity-100 border-2 border-blue-400" : ""}`}
  >
